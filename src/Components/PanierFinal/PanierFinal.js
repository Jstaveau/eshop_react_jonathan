...
export default function PanierFinal(props) {
    ...
    return <div className='d-flex flex-column flex-sm-row border border-dark mb-2 rounded-2 p-2 justify-content-between align-items-center'>
        <div className='div-img-panier align-items-center d-flex'>
